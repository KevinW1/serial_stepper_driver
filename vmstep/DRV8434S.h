...
class DRV8434S {
  public:
    ...
    /// they do not.
    bool verifySettings() {
        return driver.readReg(DRV8434SRegAddr::CTRL1) == ctrl1 &&  // current
               driver.readReg(DRV8434SRegAddr::CTRL2) == ctrl2 &&  // enable and decay mode // issue
               driver.readReg(DRV8434SRegAddr::CTRL3) == ctrl3 &&  // setp, dir, microstep
               driver.readReg(DRV8434SRegAddr::CTRL4) == ctrl4 &&  // clear faults // issue
               driver.readReg(DRV8434SRegAddr::CTRL5) == ctrl5 &&  // Stall detection enable  // issue
               driver.readReg(DRV8434SRegAddr::CTRL6) == ctrl6 &&  // Stall threshold, lower 8 bits
               driver.readReg(DRV8434SRegAddr::CTRL7) == ctrl7;    // Ripple
    }
